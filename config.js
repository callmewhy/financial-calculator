...
module.exports = {
  build: {
    ...
    // for constious operation systems.
    ...
    // the target path will contain the icon of the packaged releases
    iconPath: path.join(path.resolve(__dirname, 'build', 'resources'), 'icon'),
  },
  release: {
